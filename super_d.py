...
d_for_merge = {
 ...
 'Время': {'NF': 'Tense',
           'match_t': {'аор.': 'Aorist',
                       'буд.': 'Future',
                       # 'имперф.': '', датакласс не предусматривает
                       'наст.': 'Present'}},
 'Залог': {'NF': 'Voice',
 ...
 'Падеж': {'NF': 'GrammaticalCase',
           'match_t': {'вин.': 'Accusative',
                       # 'вин.-род.': '', датакласс не предусматривает
                       'дат.': 'Dative',
                       'зват.': 'Vocative',
                       'им.': 'Nominative',
                       'местн.': 'Locative',
 ...
 'Род': {'NF': 'GrammaticalGender',
         'match_t': {'б/р': 'No', # added
                     'ж.': 'Masculine',
                     'м.': 'Masculine',
                     # 'м. или ж.': '', датакласс не предусматривает
                     'ср.': 'Neuter'}},

 'Степень сравнения': {'NF': 'DegreeOfComparison', 'match_t': {
     # 'сравн.': '' датакласс не предусматривает
                    }
               },
 ...
 'Часть речи': {'NF': 'PartOfSpeech',
                'match_t': {
                            # 'вв.сл.': '', датакласс не предусматривает
                            'гл.': 'Verb',
                            'межд.': 'Interjection',
                            'мест.': 'Pronoun',
                            'нар.': 'Adverb',
